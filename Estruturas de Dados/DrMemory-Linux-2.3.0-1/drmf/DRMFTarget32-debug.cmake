...
set_target_properties(drsyscall PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrsyscall.so"
  IMPORTED_SONAME_DEBUG "libdrsyscall.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrsyscall.so" )
...
set_target_properties(drsymcache PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrsymcache.so"
  IMPORTED_SONAME_DEBUG "libdrsymcache.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrsymcache.so" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/libumbra.so"
  IMPORTED_SONAME_DEBUG "libumbra.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmf/lib32/debug/libumbra.so" )
...
set_target_properties(drfuzz PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrfuzz.so"
  IMPORTED_SONAME_DEBUG "libdrfuzz.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz "${_IMPORT_PREFIX}/drmf/lib32/debug/libdrfuzz.so" )

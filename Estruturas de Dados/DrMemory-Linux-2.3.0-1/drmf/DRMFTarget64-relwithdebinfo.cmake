...
set_target_properties(drsyscall PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib64/release/libdrsyscall.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsyscall.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsyscall )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsyscall "${_IMPORT_PREFIX}/drmf/lib64/release/libdrsyscall.so" )
...
set_target_properties(drsyscall_static PROPERTIES
  ...
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr_static;drcontainers;drsyms_static;drfrontendlib"
...
set_target_properties(drsymcache PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib64/release/libdrsymcache.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrsymcache.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drsymcache )
list(APPEND _IMPORT_CHECK_FILES_FOR_drsymcache "${_IMPORT_PREFIX}/drmf/lib64/release/libdrsymcache.so" )
...
set_target_properties(umbra PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELWITHDEBINFO "dynamorio;drmgr;drcontainers"
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib64/release/libumbra.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libumbra.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS umbra )
list(APPEND _IMPORT_CHECK_FILES_FOR_umbra "${_IMPORT_PREFIX}/drmf/lib64/release/libumbra.so" )
...
set_target_properties(drfuzz PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib64/release/libdrfuzz.so"
  IMPORTED_SONAME_RELWITHDEBINFO "libdrfuzz.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz "${_IMPORT_PREFIX}/drmf/lib64/release/libdrfuzz.so" )
...
set_target_properties(drfuzz_static PROPERTIES
  ...
  IMPORTED_LOCATION_RELWITHDEBINFO "${_IMPORT_PREFIX}/drmf/lib64/release/libdrfuzz_static.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS drfuzz_static )
list(APPEND _IMPORT_CHECK_FILES_FOR_drfuzz_static "${_IMPORT_PREFIX}/drmf/lib64/release/libdrfuzz_static.a" )
